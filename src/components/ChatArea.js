...
const ChatArea = ({ data }) => {
  return (
    <>
      {data !== null ? <div className='w-[70%] flex h-full flex-col overflow-y-auto' id='chatarea'>
        <div className='fixed z-30 flex items-center justify-between h-20 gap-5 px-6 py-6 bg-white w-[70%]'>
